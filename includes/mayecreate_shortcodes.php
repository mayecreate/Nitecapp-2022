...
function current_user_function( $atts ){
	ob_start();
	get_template_part('partials/content','current_user-shortcode'); 
	return ob_get_clean();
}
add_shortcode( 'current_user', 'current_user_function' );

function current_user_id_function( $atts ){
	ob_start();
	get_template_part('partials/content','current_user_id-shortcode'); 
	return ob_get_clean();
}
add_shortcode( 'current_user_id_number', 'current_user_id_function' );

function nightly_routine_function( $atts ){
	ob_start();
	get_template_part('partials/content','nightly_routine'); 
	return ob_get_clean();
}
add_shortcode( 'nightly_routine', 'nightly_routine_function' );

function morning_routine_function( $atts ){
	ob_start();
	get_template_part('partials/content','morning_routine'); 
	return ob_get_clean();
}
add_shortcode( 'morning_routine', 'morning_routine_function' );

function pleasant_function( $atts ){
	ob_start();
	get_template_part('partials/content','pleasant_activ'); 
	return ob_get_clean();
}
add_shortcode( 'pleasant_active', 'pleasant_function' );