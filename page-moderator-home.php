			...
			<div class="row">
				<?php if (($current_selected_user != 'none') || ($current_selected_user != '') || ($current_selected_user != '0')) { ?>
					...
					<div class="mod_graph_wrapper">
						...
						<button class="btn-mayecreate" onclick="download_one()">Download Sleep Efficiency Screenshot</button>
						<div id="capture_two">
						...
						<button class="btn-mayecreate" onclick="download_two()">Download Sleep Onset Latency Screenshot</button>
						...
						<button class="btn-mayecreate" onclick="download_three()">Download Wake After Sleep Onset Screenshot</button>
						<div id="capture_four">
						...
						<button class="btn-mayecreate" onclick="download_four()">Download Total Sleep Time Screenshot</button>
						<div id="capture_five">
						...
						<button class="btn-mayecreate" onclick="download_five()">Download Sleep Quality Rating Screenshot</button>
					</div>
				<?php } else { ?>
				<?php } ?>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<?php } // end the loop ?>
					<a href="<?php bloginfo('url'); ?>/wp-admin/post-new.php?post_type=llms_pa_post" class="btn-mayecreate" target="_blank">Add a New Discussion Post</a>
				
			<?php } ?>
	<?php } else { ?>
		<div class="row">
		    <div class="col-md-12">
                <h2>Sorry, you need to be an admin or moderator to view this page.</h2>
            </div>
		</div>
	<?php } ?>
